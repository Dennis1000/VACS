...
;
; arcadia.h 
; for Emerson Arcadia 2001 family
; based on the hardware equates/memory map by James Jacobs 
;
; v1.00  2003/04  Dennis D. Spreen
;
;-------------------------------------------------------------------------
...
VOLUME          equ 18FEh   ;volume and scanline scrolling
                            ;bits 7..5: horizontal scanline scrolling
                            ;bits 4:    0 = sound on
                            ;           1 = sound off
                            ;bits 3..0: volume

CHARLINE        equ 18FFh   ;current character line
...
UDC0            equ 1980h   ;$1980..$1987: user-defined character #0
UDC1            equ 1988h   ;$1988..$198F: user-defined character #1
UDC2            equ 1990h   ;$1990..$1997: user-defined character #2
UDC3            equ 1998h   ;$1998..$199F: user-defined character #3

SPRITE0DATA     equ 19A0h   ;$19A0..$19A7: sprite #0
SPRITE1DATA     equ 19A8h   ;$19A8..$19AF: sprite #1
SPRITE2DATA     equ 19B0h   ;$19B0..$19B7: sprite #2
SPRITE3DATA     equ 19B8h   ;$19B8..$19BF: sprite #3
